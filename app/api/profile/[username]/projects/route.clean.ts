...
const projectBaseSchema = z.object({
  ...
  impact: z.string().max(500, 'Impact description too long').optional(),
});
...
export async function GET(
  ...
  try {
    ...
    console.log('Fetching projects for user:', profileUser.username);
...
export async function DELETE(
  ...
  try {
    ...
    console.log('Deleting project for user:', profileUser.username, 'ID:', id);
